...
menu_binds = {
    ...
    key({},          "t",       function (w) w.menu:move_up()   end),
...
add_binds("normal", {
    ...
    key({},          "t",           function (w) w:scroll_vert(less)  end),
    key({},          "d",           function (w) w:scroll_horiz(less) end),
    key({},          "n",           function (w) w:scroll_horiz(more) end),
    key({},          "^",           function (w) w:scroll_horiz("0%") end),
    key({},          "$",           function (w) w:scroll_horiz("100%") end),
    key({},          "_",           function (w) w:scroll_horiz("0%") end),
    key({},          "-",           function (w) w:scroll_horiz("100%") end),
    ...
    key({},          "D",           function (w, m) w:prev_tab(m.count) end, {count=1}),
    key({},          "N",           function (w, m) if not w:goto_tab(m.count) then w:next_tab() end end, {count=0}),
    ...
    key({"Control"}, "k",           function (w)    w:new_tab(homepage) end),
    key({"Control"}, "w",           function (w)    w:close_tab()       end),
    key({},          "j",           function (w, m) for i=1,m.count do w:close_tab()      end end, {count=1}),
    key({},          "q",           function (w, m) for i=1,m.count do w:close_tab()      end end, {count=1}),
